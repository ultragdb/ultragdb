...
#LDLIBS := -mconsole -lkernel32 -luser32 -lgdi32 -lcomdlg32 -lcomctl32 -limm32 -lwinspool -lole32 -luuid
#LDLIBS := -mwindows -lcomctl32 -limm32 -lwinspool -lole32 -luuid -Wl,--subsystem,console 
